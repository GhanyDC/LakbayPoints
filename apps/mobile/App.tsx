...
const reportCategories: ReportCategoryOption[] = [
  ...
  {
    label: "Illegal parking or loading obstruction",
  ...
  return (
    <View
      style={[
        ...
        isRecommended && styles.routeOptionCardRecommended,
      ]}
    >
      ...
      <View style={styles.routeMetricsGrid}>
        ...
        <View style={styles.routeMetricItem}>
          ...
          <Text style={[styles.routeMetricValue, { color: "#16a34a" }]}>
            {formatRouteCo2e(route)}
          </Text>
        </View>
        {route.lakbayScoreReward ? (
          <View style={styles.routeMetricItem}>
            <Text style={styles.routeMetricLabel}>Lakbay Score</Text>
            <Text style={[styles.routeMetricValue, { color: "#2563eb" }]}>
              +{route.lakbayScoreReward}
            </Text>
          </View>
        ) : null}
      ...
      <View style={styles.corridorBlock}>
        <View style={styles.corridorInputArea}>
          <View style={styles.corridorRow}>
            ...
            <Text style={styles.corridorText} numberOfLines={1}>
              {origin}
            </Text>
          </View>
              ...
              <View style={styles.timelineRow} key={segment.id}>
                ...
                <View style={styles.timelineContent}>
                    ...
                    {mode !== "walk" && (
                      ...
                      >
                        <Text style={styles.transitBadgeText}>
                          {segment.displayMode.toUpperCase()}
                        </Text>
                      </View>
                    )}
                  ...
                  <Text style={styles.timelineSub}>
                    {segment.travelTimeMin
                      ? `${segment.travelTimeMin} min`
                      : "Travel pending"}
                    {segment.waitDwellTimeMin
                      ? ` • Every ${segment.waitDwellTimeMin} min`
                      : ""}
                  </Text>
                </View>
    ...
    <View style={styles.playbackProgressWrap}>
      ...
      <View style={styles.playbackProgressSteps}>
        {route.segments.map((segment, index) => {
          ...
          else if (segment.mode === "bus" || segment.mode === "jeepney")
            IconComp = Bus;
          ...
          return (
            <View style={styles.playbackProgressStep} key={segment.id}>
              <View
                style={[
                  styles.playbackProgressDot,
                  isActive && styles.playbackProgressDotActive,
                ]}
              >
  ...
  return (
    <ScrollView contentContainerStyle={styles.mainContainer} bounces={false}>
      ...
      <View style={styles.routeMapArea}>
        ...
        <View style={styles.routeMapOverlay}>
          <View
            style={[styles.mapPinContainer, { backgroundColor: "#16a34a" }]}
          >
            <Navigation color="#fff" size={24} />
          </View>
        </View>
      ...
      <View style={[styles.routeDetailCard, { flex: 1 }]}>
        ...
        <Text style={styles.classifierNote}>
          Prototype simulation using generated traces. For MVP, verification
          uses a rule-based confidence engine based on multiple trip signals,
          not live GPS or perfect mode detection.
        </Text>
        ...
        {classifierResult ? (
          ...
          >
            <View style={styles.verificationResultHeader}>
              ...
              <Text style={styles.verificationResultScore}>
                {classifierResult.confidenceScore}% Score
              </Text>
            </View>
            <Text style={styles.verificationResultBody}>
        ...
        <View style={{ marginTop: 24, gap: 12 }}>
          {classifierResult ? (
            <>
              ...
              >
                <Text style={styles.secondaryActionText}>Restart Playback</Text>
              </Pressable>
            </>
          ) : (
            <>
              ...
              <Pressable
                ...
                style={[
                  ...
                  {
                    backgroundColor: playbackComplete ? "#ef4444" : "#cbd5e1",
                  },
                ]}
              >
                <Text style={styles.primaryButtonText}>
                  Test suspicious trace
                </Text>
              </Pressable>
            </>
          )}
...
function RewardResultScreen({
  ...
  return (
    <ScrollView contentContainerStyle={styles.mainContainer} bounces={false}>
      <View style={styles.modernTopBar}>
        <View style={{ width: 24 }} />
        <Text style={styles.modernTopBarTitle}>Reward the Shift</Text>
        <Bell color="#1e3a8a" size={24} />
      </View>
      ...
      <View style={styles.rewardSummaryGrid}>
        <View style={styles.rewardSummaryItem}>
          ...
          <Text style={[styles.rewardSummaryValue, { color: "#2563eb" }]}>
            +{rewardResult.lakbayScoreEarned}
          </Text>
        </View>
        <View style={styles.rewardSummaryItem}>
          <Text style={styles.rewardSummaryLabel}>Campaign Points</Text>
          <Text style={[styles.rewardSummaryValue, { color: "#f59e0b" }]}>
            +{rewardResult.campaignPointsEarned}
          </Text>
        </View>
        <View style={styles.rewardSummaryItem}>
          <Text style={styles.rewardSummaryLabel}>CO2 Avoided</Text>
          <Text style={[styles.rewardSummaryValue, { color: "#16a34a" }]}>
      ...
      <View style={styles.activeStatusBox}>
        ...
        <Text style={styles.activeStatusTitle}>
          Lakbay Score: {rewardResult.updatedLakbayScore}
        </Text>
        <Text style={styles.activeStatusTitle}>
          Campaign Points: {rewardResult.updatedCampaignPoints}
        </Text>
      </View>
      ...
      <View style={{ paddingHorizontal: 20, marginTop: 24, gap: 12 }}>
        ...
        >
          <Text style={[styles.primaryButtonText, { color: "#1e3a8a" }]}>
            Back to Routes
          </Text>
        </Pressable>
      </View>
...
function ReportAccessBarrierScreen({
  ...
  return (
    <ScrollView contentContainerStyle={styles.reportContent}>
          ...
          return (
            <Pressable
              ...
              style={[
                ...
                isSelected && styles.reportGridItemSelected,
              ]}
              onPress={() => setCategory(option)}
            >
              <View
                style={[
                  styles.reportIconHexagonOuter,
                  { borderColor: option.color },
                ]}
              >
                <View
                  style={[
                    styles.reportIconHexagonInner,
      ...
      <View style={styles.reportSectionHeader}>
        <Text style={styles.reportSectionTitle}>Location</Text>
      </View>
      ...
      <View style={styles.reportSectionHeader}>
        <Text style={styles.reportSectionTitle}>
          Add a photo <Text style={styles.reportOptional}>(optional)</Text>
        </Text>
      </View>
      ...
      <View style={styles.reportDisclaimerRow}>
        ...
        <Text style={styles.reportDisclaimerText}>
          Your report helps keep our roads safe and better for everyone.
        </Text>
      </View>
    </ScrollView>
  );
    ...
    <ScrollView contentContainerStyle={styles.mainContainer} bounces={false}>
      ...
      <View style={[styles.routeOptionCard, { marginTop: 24 }]}>
        <View style={styles.routeOptionHeader}>
          ...
          <Text style={styles.routeOptionChain}>
            {readableTripChain(route)}
          </Text>
        </View>
